...
DIR = r"D:\研究所\重点研究计划\data\0830\20180827084313_HUAWEI NXT-AL10"
FILE_NAME = r"\20180827084313_HUAWEI NXT-AL10__100Hz"
            ...
            if datas[i][29] != last_time:
                if last_time == 0:
                    ...
                    Hidden_State = [0, 0, 0, math.cos(datas[i][25] * math.pi / 180),
                                    math.sin(datas[i][25] * math.pi / 180),
                                    datas[i][24], datas[i][23] - last_height]
                    last_time, lastE, lastL, last_height = datas[i][29], datas[i][21], datas[i][22], datas[i][23]
                    Input.append([datas[i][j] for j in range(1, 21)])
